...
const addUbuntu = async (req, res) => {
  const machines = [
    { host: '192.168.1.10', username: 'edgar', password: '12Edgar' },
  ...
  async function executeScript(machine) {
      return new Promise((resolve, reject) => {
          ...
          conn.on('ready', () => {
              ...
              conn.exec(`echo '${script}' > /home/${machine.username}/firecracker/firecracker_setup.sh && chmod +x /home/${machine.username}/firecracker/firecracker_setup.sh && /home/${machine.username}/firecracker/firecracker_setup.sh`, (err, stream) => {
                  if (err) {
